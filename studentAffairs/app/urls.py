...
urlpatterns = [
    ...
    path('home/student_screen/search/edit_student', views.editStudent, name='editpage'),
    path('home/student_screen/view/edit_student', views.editStudent, name='editpage'),
